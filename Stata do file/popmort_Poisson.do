...
log using "C:\Users\YuxinHuang\Work\Stata\Log", replace text
set more off

/******************************************
title: popmort_Poisson

purpose: obtain population mortality rate with flexible Poinsson model

Data: simulation data(raw): pop_dth.txt

Updated: 09/08/2023 by Yuxin Huang
*******************************************/

// change working directory

pwd
cd "C:\Users\YuxinHuang\Work\Stata\Data"
