...
log using "C:\Users\n11117761\Work\Log\cif_est_`todaydate'", replace text
set more off
...
/******************************************************************************************
	   ...
	   Data:    cancer_work.dta (cancer cohort)
	           quantiles_est.dta (Estimation result)
			   
			   
	   Created:            by Yuxin 
	   Updated: 2023-03-13 by Yuliya Leontyeva	
	   Updated: 2023-3-17 by Yuxin
...
// Integration estimate method: Legendre-Gaussian
...
frame estimates {
	use `path'\Data\WinBUGS_output\quantiles_est_gamma05.dta, clear
	gen ind = _n
...
frame create data 
frame change data
frame data: use `path'\Data\CleanData\cancer_work.dta, clear
...
forvalues j = 1/`grid' {
  ...
  // excess hazard as dirivetive of d ln(h(lnt)) / dt	
...
save cif_est_gamma05.dta, replace
